  ...
  return (
    <section id="contact" className="bg-parchment py-28 px-6 border-t border-steel/15">
      <div className="max-w-[760px] mx-auto text-center">
        {/* Eyebrow */}
        <span className="font-mono text-[9px] uppercase tracking-[0.25em] text-ink/35 block mb-8">
        ...
        {/* Body */}
        <p className="font-sans font-light text-[15px] text-ink/55 max-w-[440px] mx-auto leading-relaxed">
        ...
        <Link
          href="#"
          className="inline-flex items-center gap-2 border border-ink/30 text-ink font-mono text-[10px] uppercase tracking-[0.2em] px-10 py-4 mt-10 hover:bg-ink hover:text-white transition-all duration-200"
        >
          Book Your Intake →
        </Link>
      </div>
