...
const STATIC_PAGES: StaticEntry[] = [
  ...
  { path: '/contract-drafting/',                changeFrequency: 'monthly', priority: 0.8 },
  { path: '/creator/',                          changeFrequency: 'monthly', priority: 0.8 },
  ...
  { path: '/entity-structuring/',               changeFrequency: 'monthly', priority: 0.9 },
  ...
  { path: '/prenup/',                           changeFrequency: 'monthly', priority: 0.9 },
  ...
  { path: '/startup/',                          changeFrequency: 'monthly', priority: 0.9 },
  ...
  { path: '/tax-strategy/',                     changeFrequency: 'monthly', priority: 0.9 },
